<?php 
	...
	require_once($_SERVER['DOCUMENT_ROOT'].'/2whale/config/domains/2whale/config.php'); 
	require_once($_SERVER['DOCUMENT_ROOT'].'/2whale/lib/function/main_function.php');
	require_once('catalog/setup.php'); 
	require_once($_SERVER['DOCUMENT_ROOT'].'/2whale/lib/system/loader/autoload.php'); 
	// $route = array(
	// 	'login'
	// );
	// if(get('route')==''){
