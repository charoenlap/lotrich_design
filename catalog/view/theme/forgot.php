        ...
        <div class="col-md-12">
            <form role="form">
    		    ...
    		    <form target="_blank" action="#" class="mt-3">
    		        <input class="form-control" type="email" placeholder="กรุณาใส่อีเมลของท่าน xx@gmail.com"/>
                    <div class="load-btn mt-20">
                        <input type="submit" class="hvr-btn btn-block" value="ยืนยันการเปลี่ยนรหัสผ่าน">
                    </div>
    		    </form>
    		</div>
    	</div>
